"""
Django settings for restless_sea_42144 project.
...
ROOT_URLCONF = 'restless_sea_42144.urls'
...
WSGI_APPLICATION = 'restless_sea_42144.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_sea_42144 API",
    "DESCRIPTION": "API documentation for restless_sea_42144 App",
    "VERSION": "v1",
}
